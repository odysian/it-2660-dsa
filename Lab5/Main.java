class Main {
  public static void main(String[] args) {
    ...
    System.out.println("Search result for 36: " + lab5Tree.search(36));

    // Step 8 - Display the result of a search for the value 37
    System.out.println("Search result for 37: " + lab5Tree.search(37));

    // Step 9 - Using the path() method, display the path from the root to 2

    // Used a for loop to print the element of each node in the path
    System.out.println("Path from root to 2: ");
    for (var node: lab5Tree.path(2)) {
